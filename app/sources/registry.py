...
SOURCE_SPECS: tuple[SourceSpec, ...] = (
    ...
    SourceSpec(lottery_code="BALOTO", draw_types=("BALOTO",), primary_name="Baloto", primary_url="https://www.baloto.com/resultados-baloto/2712", primary_verified=True, notes="Official result page; official draw page; draw number must be rotated as new official draws are published."),
    SourceSpec(lottery_code="REVANCHA", draw_types=("REVANCHA",), primary_name="Baloto", primary_url="https://www.baloto.com/resultados-baloto/2712", primary_verified=True, notes="Official result page; draw 2712 currently published. URL requires draw-number rotation for subsequent draws."),
