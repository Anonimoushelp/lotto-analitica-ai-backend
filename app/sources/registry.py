...
SOURCE_SPECS: tuple[SourceSpec, ...] = (
    SourceSpec(lottery_code="MILOTO", draw_types=("MILOTO",), primary_name="Baloto", primary_url="https://www.baloto.com/miloto/resultados/?page=1", primary_verified=True, notes="Official historical-results page; parser reads the latest published draw."),
    SourceSpec(lottery_code="BALOTO", draw_types=("BALOTO",), primary_name="Baloto", primary_url="https://www.baloto.com/resultados-baloto/?page=1", primary_verified=True, notes="Official result page; draw 2712 currently published. URL requires draw-number rotation for subsequent draws."),
    SourceSpec(lottery_code="REVANCHA", draw_types=("REVANCHA",), primary_name="Baloto", primary_url="https://www.baloto.com/resultados-baloto/?page=1", primary_verified=True, notes="Official result page; draw 2712 currently published. URL requires draw-number rotation for subsequent draws."),
    SourceSpec(lottery_code="SUPER_ASTRO", draw_types=("ASTRO_SOL", "ASTRO_LUNA"), primary_name="Super Astro", primary_url="https://www.superastro.com.co/resultados-super-astro-sol-super-astro-luna.php", primary_verified=True, notes="Official results page; parser reads the latest Sol and Luna rows."),
