...
from app.schemas.user import LoginRequest, TokenResponse, UserAdminUpdate, UserCreate, UserResponse
...
def update_user(
    ...
    if all(value is None for value in (payload.email, payload.password, payload.role, payload.is_active)):
