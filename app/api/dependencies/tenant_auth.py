...
require_predictions_read = require_tenant_scopes("predictions:read")
require_predictions_generate = require_tenant_scopes("predictions:generate")
require_analytics_read = require_tenant_scopes("analytics:read")
require_crypto_use = require_tenant_scopes("crypto:use")
require_tenant_manage = require_tenant_scopes("tenant:manage")
require_memberships_manage = require_tenant_scopes("memberships:manage")
